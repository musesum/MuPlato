...
// origin
let Z = VertexRange(0, 0, 0, .Z)
// Tetrahedron
let T0 = VertexRange( 1, 1, 1, .T0)
let T1 = VertexRange(-1, 1,-1, .T1)
let T2 = VertexRange( 1,-1,-1, .T2)
let T3 = VertexRange(-1,-1, 1, .T3)
                       // Cube, will include Tetrahedron points
let C0 = VertexRange( 1, 1,-1, .C0)
let C1 = VertexRange(-1, 1, 1, .C1)
let C2 = VertexRange( 1,-1, 1, .C2)
let C3 = VertexRange(-1,-1,-1, .C3)
                       // Octahedron. each Pnt is middle of a Cube's face
let O0 = VertexRange( 0, 0, 1, .O0)
let O1 = VertexRange(-1, 0, 0, .O1)
let O2 = VertexRange( 1, 0, 0, .O2)
let O3 = VertexRange( 0, 0,-1, .O3)
let O4 = VertexRange( 0, 1, 0, .O4)
let O5 = VertexRange( 0,-1, 0, .O5)
// Dodecahedron, will include Cube and Tetrahedron points
let D0 = VertexRange( 0, 𝚽, φ, .D0)
let D1 = VertexRange( 0, 𝚽,-φ, .D1)
let D2 = VertexRange(-𝚽, φ, 0, .D2)
let D3 = VertexRange(-𝚽,-φ, 0, .D3)
let D4 = VertexRange(-φ, 0, 𝚽, .D4)
let D5 = VertexRange( φ, 0, 𝚽, .D5)
let D6 = VertexRange( 𝚽, φ, 0, .D6)
let D7 = VertexRange( 𝚽,-φ, 0, .D7)
let D8 = VertexRange(-φ, 0,-𝚽, .D8)
let D9 = VertexRange( φ, 0,-𝚽, .D9)
let DA = VertexRange( 0,-𝚽, φ, .DA)
let DB = VertexRange( 0,-𝚽,-φ, .DB)
// Icosahedron
let I0 = VertexRange( Rφ,  R,  0, .I0)
let I1 = VertexRange(  R,  0, Rφ, .I1)
let I2 = VertexRange(  R,  0,-Rφ, .I2)
let I3 = VertexRange( Rφ, -R,  0, .I3)
let I4 = VertexRange(  0,-Rφ, -R, .I4)
let I5 = VertexRange(-Rφ, -R,  0, .I5)
let I6 = VertexRange( -R,  0,-Rφ, .I6)
let I7 = VertexRange( -R,  0, Rφ, .I7)
let I8 = VertexRange(-Rφ,  R,  0, .I8)
let I9 = VertexRange(  0, Rφ,  R, .I9)
let IA = VertexRange(  0,-Rφ,  R, .IA)
let IB = VertexRange(  0, Rφ, -R, .IB)
