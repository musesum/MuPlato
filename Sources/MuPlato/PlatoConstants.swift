...
// origin
let Z = Vertex01(0, 0, 0, .Z)
// Tetrahedron
let T0 = Vertex01( 1, 1, 1, .T0)
let T1 = Vertex01(-1, 1,-1, .T1)
let T2 = Vertex01( 1,-1,-1, .T2)
let T3 = Vertex01(-1,-1, 1, .T3)
                       // Cube, will include Tetrahedron points
let C0 = Vertex01( 1, 1,-1, .C0)
let C1 = Vertex01(-1, 1, 1, .C1)
let C2 = Vertex01( 1,-1, 1, .C2)
let C3 = Vertex01(-1,-1,-1, .C3)
                       // Octahedron. each Pnt is middle of a Cube's face
let O0 = Vertex01( 0, 0, 1, .O0)
let O1 = Vertex01(-1, 0, 0, .O1)
let O2 = Vertex01( 1, 0, 0, .O2)
let O3 = Vertex01( 0, 0,-1, .O3)
let O4 = Vertex01( 0, 1, 0, .O4)
let O5 = Vertex01( 0,-1, 0, .O5)
// Dodecahedron, will include Cube and Tetrahedron points
let D0 = Vertex01( 0, 𝚽, φ, .D0)
let D1 = Vertex01( 0, 𝚽,-φ, .D1)
let D2 = Vertex01(-𝚽, φ, 0, .D2)
let D3 = Vertex01(-𝚽,-φ, 0, .D3)
let D4 = Vertex01(-φ, 0, 𝚽, .D4)
let D5 = Vertex01( φ, 0, 𝚽, .D5)
let D6 = Vertex01( 𝚽, φ, 0, .D6)
let D7 = Vertex01( 𝚽,-φ, 0, .D7)
let D8 = Vertex01(-φ ,0,-𝚽, .D8)
let D9 = Vertex01( φ, 0,-𝚽, .D9)
let DA = Vertex01( 0,-𝚽, φ, .DA)
let DB = Vertex01( 0,-𝚽,-φ, .DB)
// Icosahedron
let I0 = Vertex01( Rφ,  R,  0, .I0)
let I1 = Vertex01(  R,  0, Rφ, .I1)
let I2 = Vertex01(  R,  0,-Rφ, .I2)
let I3 = Vertex01( Rφ, -R,  0, .I3)
let I4 = Vertex01(  0,-Rφ, -R, .I4)
let I5 = Vertex01(-Rφ, -R,  0, .I5)
let I6 = Vertex01( -R,  0,-Rφ, .I6)
let I7 = Vertex01( -R,  0, Rφ, .I7)
let I8 = Vertex01(-Rφ,  R,  0, .I8)
let I9 = Vertex01(  0, Rφ,  R, .I9)
let IA = Vertex01(  0,-Rφ,  R, .IA)
let IB = Vertex01(  0, Rφ, -R, .IB)
