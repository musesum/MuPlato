...
extension Platonic { 
    ...
    func buildZeroTetra() -> PlatoModel {
        ...
        let Z_T0 = Vertex01(Z, T0, .Z_T0)
        let Z_T1 = Vertex01(Z, T1, .Z_T1)
        let Z_T2 = Vertex01(Z, T2, .Z_T2)
        let Z_T3 = Vertex01(Z, T3, .Z_T3)
    ...
    func buildTetraCubeA() -> PlatoModel {
        ...
        let T0_T012 = Vertex01(T0, (T0,T1,T2), .T0_T012)
        let T1_T013 = Vertex01(T1, (T0,T1,T3), .T1_T013)
        let T2_T023 = Vertex01(T2, (T0,T2,T3), .T2_T023)
        let T3_T123 = Vertex01(T3, (T1,T2,T3), .T3_T123)
    ...
    func buildTetraCubeB() -> PlatoModel {
        ...
        let T012_C0 = Vertex01((T0,T1,T2), C0, .T012_C0)
        let T013_C1 = Vertex01((T0,T1,T3), C1, .T013_C1)
        let T023_C2 = Vertex01((T0,T2,T3), C2, .T023_C2)
        let T123_C3 = Vertex01((T1,T2,T3), C3, .T123_C3)
    ...
    func buildCubeOctA() -> PlatoModel {
        ...
        let T0_O0 = Vertex01(T0, O0, .T0_O0)
        let T1_O1 = Vertex01(T1, O1, .T1_O1)
        let T2_O2 = Vertex01(T2, O2, .T2_O2)
        let T3_O3 = Vertex01(T2, O3, .T3_O3)
        let T1_O4 = Vertex01(T1, O4, .T1_O4)
        let T3_O5 = Vertex01(T3, O5, .T3_O5)
    ...
    func buildCubeOctB() -> PlatoModel {
        ...
        let T0_O2 = Vertex01(T0, O2, .T0_O2)
        let T1_O1 = Vertex01(T1, O1, .T1_O1)
        let T2_O2 = Vertex01(T2, O2, .T2_O2)
        let T3_O1 = Vertex01(T3, O1, .T3_O1)
        let C0_O3 = Vertex01(C0, O3, .C0_O3)
        let C1_O0 = Vertex01(C1, O0, .C1_O0)
        let C2_O0 = Vertex01(C2, O0, .C2_O0)
        let C3_O3 = Vertex01(C3, O3, .C3_O3)
    ...
    func buildOctCube() -> PlatoModel {
        ...
        let O2_T0 = Vertex01(O2, T0, .O2_T0)
        let O1_T1 = Vertex01(O1, T1, .O1_T1)
        let O2_T2 = Vertex01(O2, T2, .O2_T2)
        let O1_T3 = Vertex01(O1, T3, .O1_T3)
        let O3_C0 = Vertex01(O3, C0, .O3_C0)
        let O0_C1 = Vertex01(O0, C1, .O0_C1)
        let O0_C2 = Vertex01(O0, C2, .O0_C2)
        let O3_C3 = Vertex01(O3, C3, .O3_C3)
    ...
    func buildCubeDodecA() -> PlatoModel {
        ...
        let O4_D0 = Vertex01(O4, D0, .O4_D0)
        let O4_D1 = Vertex01(O4, D1, .O4_D1)
        let O1_D2 = Vertex01(O1, D2, .O1_D2)
        let O1_D3 = Vertex01(O1, D3, .O1_D3)
        let O0_D4 = Vertex01(O0, D4, .O0_D4)
        let O0_D5 = Vertex01(O0, D5, .O0_D5)
        let O2_D6 = Vertex01(O2, D6, .O2_D6)
        let O2_D7 = Vertex01(O2, D7, .O2_D7)
        let O3_D8 = Vertex01(O3, D8, .O3_D8)
        let O3_D9 = Vertex01(O3, D9, .O3_D9)
        let O5_DA = Vertex01(O5, DA, .O5_DA)
        let O5_DB = Vertex01(O5, DB, .O5_DB)

        let O0_D45 = Vertex01(mid: (O0_D4, O0_D5), .O0_D45)
        let O1_D23 = Vertex01(mid: (O1_D2, O1_D3), .O1_D23)
        let O2_D67 = Vertex01(mid: (O2_D6, O2_D7), .O2_D67)
        let O3_D89 = Vertex01(mid: (O3_D8, O3_D9), .O3_D89)
        let O4_D01 = Vertex01(mid: (O4_D0, O4_D1), .O4_D01)
        let O5_DAB = Vertex01(mid: (O5_DA, O5_DB), .O5_DAB)
    ...
    func buildCubeDodecB() -> PlatoModel {
        ...
        let D45_D5 = Vertex01((D4,D5), D5, .D45_D5)
        let D23_D2 = Vertex01((D2,D3), D2, .D23_D2)
        let D67_D7 = Vertex01((D6,D7), D7, .D67_D7)
        let D89_D8 = Vertex01((D8,D9), D8, .D89_D8)
        let D01_D1 = Vertex01((D0,D1), D1, .D01_D1)
        let DAB_DA = Vertex01((DA,DB), DA, .DAB_DA)
    ...
    func buildDodecFaceA() -> PlatoModel {
        ...
        let T0_I0 = Vertex01(T0, I0, .T0_I0)
        let T0_I1 = Vertex01(T0, I1, .T0_I1)
        let C0_I2 = Vertex01(C0, I2, .C0_I2)
        let T2_I3 = Vertex01(T2, I3, .T2_I3)
        let T2_I4 = Vertex01(T2, I4, .T2_I4)
        let C3_I5 = Vertex01(C3, I5, .C3_I5)
        let C3_I6 = Vertex01(C3, I6, .C3_I6)
        let T3_I7 = Vertex01(T3, I7, .T3_I7)
        let C1_I8 = Vertex01(C1, I8, .C1_I8)
        let C1_I9 = Vertex01(C1, I9, .C1_I9)
        let T3_IA = Vertex01(T3, IA, .T3_IA)
        let C0_IB = Vertex01(C0, IB, .C0_IB)
    ...
    func buildDodecFaceB() -> PlatoModel {
        ...
        let T0_T0D0 = Vertex01(T0, (T0,D0), .T0_T0D0)
        let D0_D0D1 = Vertex01(D0, (D0,D1), .D0_D0D1)
        let D1_D1C0 = Vertex01(D1, (D1,C0), .D1_D1C0)
        let C0_C0D6 = Vertex01(C0, (C0,D6), .C0_C0D6)
        let D6_D6T0 = Vertex01(D6, (D6,T0), .D6_D6T0)
        let T0_T0D5 = Vertex01(T0, (T0,D5), .T0_T0D5)
        let D5_D5C2 = Vertex01(D5, (D5,C2), .D5_D5C2)
        let C2_C2D7 = Vertex01(C2, (D7,C2), .C2_C2D7)
        let D7_D7D6 = Vertex01(D7, (D7,D6), .D7_D7D6)
        let D6_D6C0 = Vertex01(D6, (D6,C0), .D6_D6C0)
        let C0_CoD9 = Vertex01(C0, (C0,D9), .C0_CoD9)
        let D9_D9T2 = Vertex01(D9, (D9,T2), .D9_D9T2)
        let T2_T2D7 = Vertex01(T2, (T2,D7), .T2_T2D7)
        let D7_D7C2 = Vertex01(D7, (D7,C2), .D7_D7C2)
        let C2_C2DA = Vertex01(C2, (C2,DA), .C2_C2DA)
        let DA_DADB = Vertex01(DA, (DA,DB), .DA_DADB)
        let DB_DBT2 = Vertex01(DB, (DB,T2), .DB_DBT2)
        let T2_T2D9 = Vertex01(T2, (T2,D9), .T2_T2D9)
        let D9_D9D8 = Vertex01(D9, (D9,D8), .D9_D9D8)
        let D8_D8C3 = Vertex01(D8, (D8,C3), .D8_D8C3)
        let C3_C3DB = Vertex01(C3, (C3,DB), .C3_C3DB)
        let DB_DBDA = Vertex01(DB, (DB,DA), .DB_DBDA)
        let DA_DAT3 = Vertex01(DA, (DA,T3), .DA_DAT3)
        let T3_T3D3 = Vertex01(T3, (T3,D3), .T3_T3D3)
        let D3_D3C3 = Vertex01(D3, (D3,C3), .D3_D3C3)
        let C3_C3D8 = Vertex01(C3, (C3,D8), .C3_C3D8)
        let D8_D8T1 = Vertex01(D8, (D8,T1), .D8_D8T1)
        let T1_T1D2 = Vertex01(T1, (T1,D2), .T1_T1D2)
        let D2_D2D3 = Vertex01(D2, (D2,D3), .D2_D2D3)
        let D3_D3T3 = Vertex01(D3, (D3,T3), .D3_D3T3)
        let T3_T3D4 = Vertex01(T3, (T3,D4), .T3_T3D4)
        let D4_D4C1 = Vertex01(D4, (D4,C1), .D4_D4C1)
        let C1_C1D2 = Vertex01(C1, (C1,D2), .C1_C1D2)
        let D2_D2T1 = Vertex01(D2, (D2,T1), .D2_D2T1)
        let T1_T1D1 = Vertex01(T1, (T1,D1), .T1_T1D1)
        let D1_D1D0 = Vertex01(D1, (D1,D0), .D1_D1D0)
        let D0_D0C1 = Vertex01(D0, (D0,C1), .D0_D0C1)
        let C1_C1D4 = Vertex01(C1, (C1,D4), .C1_C1D4)
        let D4_D4D5 = Vertex01(D4, (D4,D5), .D4_D4D5)
        let D5_D5T0 = Vertex01(D5, (D5,T0), .D5_D5T0)
    ...
    func buildDodecIcosa() -> PlatoModel {
        ...
        let T0_I019 = Vertex01(T0, (I0,I1,I9), .T0_I019)
        let T1_I6B8 = Vertex01(T1, (I6,IB,I8), .T1_I6B8)
        let T2_I234 = Vertex01(T2, (I2,I3,I4), .T2_I234)
        let T3_I57A = Vertex01(T3, (I5,I7,IA), .T3_I57A)
        let C0_I02B = Vertex01(C0, (I0,I2,IB), .C0_I02B)
        let C1_I897 = Vertex01(C1, (I8,I9,I7), .C1_I897)
        let C2_I13A = Vertex01(C2, (I1,I3,IA), .C2_I13A)
        let C3_I456 = Vertex01(C3, (I4,I5,I6), .C3_I456)
        let D0_I089 = Vertex01(D0, (I0,I8,I9), .D0_I089)
        let D1_I08B = Vertex01(D1, (I0,I8,IB), .D1_I08B)
        let D2_I678 = Vertex01(D2, (I6,I7,I8), .D2_I678)
        let D3_I567 = Vertex01(D3, (I5,I6,I7), .D3_I567)
        let D4_I79A = Vertex01(D4, (I7,I9,IA), .D4_I79A)
        let D5_I19A = Vertex01(D5, (I1,I9,IA), .D5_I19A)
        let D6_I012 = Vertex01(D6, (I0,I1,I2), .D6_I012)
        let D7_I123 = Vertex01(D7, (I1,I2,I3), .D7_I123)
        let D8_I46B = Vertex01(D8, (I4,I6,IB), .D8_I46B)
        let D9_I24B = Vertex01(D9, (I2,I4,IB), .D9_I24B)
        let DA_I35A = Vertex01(DA, (I3,I5,IA), .DA_I35A)
        let DB_I345 = Vertex01(DB, (I3,I4,I5), .DB_I345)

        let T0_D0I09 = Vertex01((T0_I019, D0_I089), (I0, I9), .T0_D0I09)
        let D0_D1I08 = Vertex01((D0_I089, D1_I08B), (I0, I8), .D0_D1I08)
        let D1_C0I0B = Vertex01((D1_I08B, C0_I02B), (I0, IB), .D1_C0I0B)
        let C0_D6I02 = Vertex01((C0_I02B, D6_I012), (I0, I2), .C0_D6I02)
        let D6_T0I01 = Vertex01((D6_I012, T0_I019), (I0, I1), .D6_T0I01)
        let T0_D5I19 = Vertex01((T0_I019, D5_I19A), (I1, I9), .T0_D5I19)
        let D5_C2I1A = Vertex01((D5_I19A, C2_I13A), (I1, IA), .D5_C2I1A)
        let C2_D7I13 = Vertex01((C2_I13A, D7_I123), (I1, I3), .C2_D7I13)
        let D7_D6I12 = Vertex01((D7_I123, D6_I012), (I1, I2), .D7_D6I12)
        let D6_C0I02 = Vertex01((D6_I012, C0_I02B), (I0, I2), .D6_C0I02)
        let C0_D9I2B = Vertex01((C0_I02B, D9_I24B), (I2, IB), .C0_D9I2B)
        let D9_T2I24 = Vertex01((D9_I24B, T2_I234), (I2, I4), .D9_T2I24)
        let T2_D7I23 = Vertex01((T2_I234, D7_I123), (I2, I3), .T2_D7I23)
        let D7_C2I13 = Vertex01((D7_I123, C2_I13A), (I1, I3), .D7_C2I13)
        let C2_DAI3A = Vertex01((C2_I13A, DA_I35A), (I3, IA), .C2_DAI3A)
        let DA_DBI35 = Vertex01((DA_I35A, DB_I345), (I3, I5), .DA_DBI35)
        let DB_T2I34 = Vertex01((DB_I345, T2_I234), (I3, I4), .DB_T2I34)
        let T2_D9I24 = Vertex01((T2_I234, D9_I24B), (I2, I4), .T2_D9I24)
        let D9_D8I4B = Vertex01((D9_I24B, D8_I46B), (I4, IB), .D9_D8I4B)
        let D8_C3I46 = Vertex01((D8_I46B, C3_I456), (I4, I6), .D8_C3I46)
        let C3_DBI45 = Vertex01((C3_I456, DB_I345), (I4, I5), .C3_DBI45)
        let DB_DAI35 = Vertex01((DB_I345, DA_I35A), (I3, I5), .DB_DAI35)
        let DA_T3I5A = Vertex01((DA_I35A, T3_I57A), (I5, IA), .DA_T3I5A)
        let T3_D3I75 = Vertex01((T3_I57A, D3_I567), (I7, I5), .T3_D3I75)
        let D3_C3I56 = Vertex01((D3_I567, C3_I456), (I5, I6), .D3_C3I56)
        let C3_D8I46 = Vertex01((C3_I456, D8_I46B), (I4, I6), .C3_D8I46)
        let D8_T1I6B = Vertex01((D8_I46B, T1_I6B8), (I6, IB), .D8_T1I6B)
        let T1_D2I68 = Vertex01((T1_I6B8, D2_I678), (I6, I8), .T1_D2I68)
        let D2_D3I67 = Vertex01((D2_I678, D3_I567), (I6, I7), .D2_D3I67)
        let D3_T3I57 = Vertex01((D3_I567, T3_I57A), (I5, I7), .D3_T3I57)
        let T3_D4I7A = Vertex01((T3_I57A, D4_I79A), (I7, IA), .T3_D4I7A)
        let D4_C1I79 = Vertex01((D4_I79A, C1_I897), (I7, I9), .D4_C1I79)
        let C1_D2I78 = Vertex01((C1_I897, D2_I678), (I7, I8), .C1_D2I78)
        let D2_T1I68 = Vertex01((D2_I678, T1_I6B8), (I6, I8), .D2_T1I68)
        let T1_D1I8B = Vertex01((T1_I6B8, D1_I08B), (I8, IB), .T1_D1I8B)
        let D1_D0I08 = Vertex01((D1_I08B, D0_I089), (I0, I8), .D1_D0I08)
        let D0_C1I89 = Vertex01((D0_I089, C1_I897), (I8, I9), .D0_C1I89)
        let C1_D4I79 = Vertex01((C1_I897, D4_I79A), (I7, I9), .C1_D4I79)
        let D4_D5IA9 = Vertex01((D4_I79A, D5_I19A), (IA, I9), .D4_D5IA9)
        let D5_T0I19 = Vertex01((D5_I19A, T0_I019), (I1, I9), .D5_T0I19)
